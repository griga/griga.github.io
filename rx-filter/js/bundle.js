    ...
    return {
        fetch: function fetch(filter) {
            ...
            var i = _.chain(items).filter(function (_i) {
                ...
                return filter.duration.min <= _i.duration && _i.duration <= filter.duration.max;
